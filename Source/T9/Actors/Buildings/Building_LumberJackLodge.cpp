...
#include "Building_LumberJackLodge.h"
...
ABuilding_LumberJackLodge::ABuilding_LumberJackLodge(const FObjectInitializer& ObjectInitializer) {
...
void ABuilding_LumberJackLodge::BeginPlay()
{
