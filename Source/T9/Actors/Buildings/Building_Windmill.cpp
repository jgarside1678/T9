...
ABuilding_Windmill::ABuilding_Windmill(const FObjectInitializer& ObjectInitializer) {
	...
	Upgrades.Add(1, FBuildingUpgrades{ 100.0f, 100, 1000.0f, 10.0f, FBuildingCosts{100, 100, 100, 0}, FBuildingAttack{0,0, 2}, FBuildingProduction{0,0,0,100} });
	Upgrades.Add(2, FBuildingUpgrades{ 250.0f, 250, 2000.0f, 100.0f, FBuildingCosts{2500, 2000, 2000, 0}, FBuildingAttack{0,0, 5}, FBuildingProduction{0,0,0,200} });
	Upgrades.Add(3, FBuildingUpgrades{ 500.0f, 350, 4000.0f, 250.0f, FBuildingCosts{5000, 5000, 5000, 0}, FBuildingAttack{0,0, 6}, FBuildingProduction{0,0,0,300} });
