...
AAlliance_Hunter::AAlliance_Hunter() {
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> AnimationAsset(TEXT("AnimBlueprint'/Game/Units/Alliance/StylizedHumanMale/Animations/AllianceHunterAnimation_BP.AllianceHunterAnimation_BP_C'"));
