...
AEnemy_Lich_Mage::AEnemy_Lich_Mage(const FObjectInitializer& ObjectInitializer) {
	...
	Levels.Add(1, FCharacterLevels{ 300, 500, 300, 0, 1000 });
	Levels.Add(2, FCharacterLevels{ 300, 300, 400, 0, 1000 });
	Levels.Add(3, FCharacterLevels{ 300, 300, 500, 0, 1000 });
	Levels.Add(4, FCharacterLevels{ 300, 300, 600, 0, 1000 });
	Levels.Add(5, FCharacterLevels{ 300, 300, 700, 0, 1000 });
	Levels.Add(6, FCharacterLevels{ 300, 300, 800, 0, 1000 });
	Levels.Add(7, FCharacterLevels{ 300, 300, 900, 0, 1000 });
	Levels.Add(8, FCharacterLevels{ 300, 300, 1000, 0, 1000 });
	Levels.Add(9, FCharacterLevels{ 300, 300, 1100, 0, 1000 });
	Levels.Add(10, FCharacterLevels{ 300, 300, 1200, 0, 1000 });
	Levels.Add(11, FCharacterLevels{ 300, 300, 1300, 0, 1000 });
	DeathTime = 1.8;
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> AnimationMont(TEXT("AnimMontage'/Game/AI/Enemies/Lich/Animations/Lich_Mage_Attack_Montage.Lich_Mage_Attack_Montage'"));
